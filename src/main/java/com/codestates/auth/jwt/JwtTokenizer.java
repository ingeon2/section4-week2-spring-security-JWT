...
//클라이언트의 요청이 들어올 때마다 전달된 JWT를 검증하는 역할



//Spring Container(ApplicationContext)에 Bean으로 등록하기 위해 @Component 애너테이션을 추가
@Component
public class JwtTokenizer {
    ...
    //위에서 사용할 매서드 (hmacShaKeyFor 알고리즘으로 암호화하는 매서드)
